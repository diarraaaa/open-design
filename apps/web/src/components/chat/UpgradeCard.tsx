 ...
 *
 * 产品原有的软提醒弹窗 `AmrLowBalanceDialog`(居中硬阻断)**已于 2026-09-06 删除**,
 * 原话「软提醒弹窗就是产品告诉我不要这个的,只用弹那个插画的就行」。所以软那一档
 * 现在只剩这张卡;首页没有流水,那一档**什么都不显示、直接放行**。见规格 **T53**。
 * (这里原先写的是「另记 T40」—— 那是个断指针,T40 讲的是软提醒不许拖慢运行。)
 *
 * 两档由余额本身决定,没有第三档:
